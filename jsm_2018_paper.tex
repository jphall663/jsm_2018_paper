...
% Used modified ICM template
\usepackage[accepted]{icml2013}

% Short title
\icmltitlerunning{A Survey of Model Interpretation Tools with Practical Recommendations}

\begin{document} 

\twocolumn[
\icmltitle{A Survey of Model Interpretation Tools\\
